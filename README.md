...
## Как я понял задание
- Первый этап - дать возможность пользователю выбрать количество загружаемых данных. В нашем случае 32 или 1000 елементов.
- Второй этап - отрисовать данные в таблице, реализовать сортировку в таблице по клику по заголовку ячейки(от меньшего к большему и обратно). По клику на елемент (рядок таблицы) - выводить информацию в отдельном блоке.
- Третий этап - реализовать разбиение данных, по 50 шт. Соответственно сделать пейджер
- Четвертый этап - сделать поиск по таблице. (реализован поиск по имени и фамилии)

> Чтоб не тратить время на верстку - использовался bootstrap(в задании написано что можно использовать сторонние библиотеки)
